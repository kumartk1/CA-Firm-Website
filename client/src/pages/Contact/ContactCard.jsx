...
const ContactCard = ({contactData,index}) => {
    ...
    return (
    <div className='flex flex-col items-center bg-gray-200 p-4 py-6 rounded-md md:min-h-[200px] md:min-w-[300px] justify-center gap-y-5 border-[1px] border-gray-300 hover:scale-105 transition-all duration-200 ease-in-out md:w-1/4'>
        ...
        <div className='max-w-5/6'>
            <button className='bg-gray-900 text-white px-3 py-2 rounded-md overflow-ellipsis hover:hover-underline-animation-btn hover:scale-110 transition-all duration-200 ease-in-out w-[220px] md:w-full'><span className='hover-underline-animation cursor-pointer font-semibold tracking-wide text-[12px] md:text-[16px]'>{contact}</span></button>
        </div>
    </div>
  )
}
