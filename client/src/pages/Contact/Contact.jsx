...
const Contact = () => {
  ...
  return (
    <div className='min-h-screen h-fit'>
      ...
      {/* Hero Section */}
      <motion.div
        className='bg-gray-200 flex flex-col items-center mb-10 border-b-2 border-b-slate-700 min-h-[400px]'
        ref={heroRef}
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: heroInView ? 1 : 0, y: heroInView ? 0 : -30 }}
        transition={{ duration: 0.8, ease: 'easeOut' }}
      >
        <div className='w-3/4 p-2 py-4 m-auto overflow-y-auto text-center md:w-2/4'>
          <div className='flex flex-col justify-center text-slate-600 gap-y-5'>
            ...
            <button className="bg-gray-800 text-white px-4 py-2 flex items-center justify-center rounded gap-2 max-w-[150px] font-bold tracking-wide hover-underline-animation-btn text-[14px] md:text-[1rem] mx-auto">
      ...
      <motion.div
        className='flex flex-wrap gap-10 my-16 justify-evenly'
        ref={contactCardsRef}
      ...
      <motion.div
        className="flex flex-col items-center justify-center mb-10 location md:flex-row"
        ref={officesRef}
        initial={{ opacity: 0, y: -30 }}
