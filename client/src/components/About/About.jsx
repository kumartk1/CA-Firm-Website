        ...
        <div className="flex flex-col items-center">
          ...
          >
            <img
              src={backgroundImg}
              alt="Background"
              className="mx-auto transition-transform duration-500 transform shadow-lg rounded-xl hover:scale-105"
          ...
          >
            ...
            <div className="text-center">
              <button 
                className="px-6 py-3 mt-4 text-white transition-transform duration-300 ease-in-out transform bg-blue-600 rounded-lg shadow-md hover:scale-105 hover:bg-black hover:text-white hover:shadow-lg"
